export const whyMeHomeTr = {
  ...
  whyMeTransparentDesc:
    "Açık iletişim ve şeffaf fiyatlandırma ile ilerleriz; kapsam, takvim ve maliyetleri baştan netleştirir, süreç boyunca ne yaptığımızı paylaşır ve sürpriz maliyetlerle karşılaşmamanızı sağlarız.",
