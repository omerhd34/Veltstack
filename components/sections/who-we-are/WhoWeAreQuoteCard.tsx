...
export function WhoWeAreQuoteCard({
  ...
  return (
    <article
      className={cn(
        "group relative flex h-full w-full flex-col overflow-hidden rounded-3xl bg-white px-2 py-8 sm:px-8 md:p-10",
    ...
    >
      ...
      <footer className="relative mx-5 mt-8 shrink-0 rounded-2xl border border-brand-accent/10 bg-[#f3faf6] p-5 md:mx-6 md:p-6 lg:mt-auto">
