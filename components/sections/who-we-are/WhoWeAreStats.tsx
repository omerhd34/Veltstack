...
function StatCard({
  ...
  return (
    <div
      className={cn(
        "group relative w-full overflow-hidden rounded-2xl border border-brand-accent/12 bg-white/70 px-4 py-4 shadow-[0_4px_20px_rgb(58_107_82/0.06)] backdrop-blur-sm transition-all duration-300 sm:px-5 sm:py-5 md:px-6",
    ...
    >
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgb(58_107_82/0.08),transparent_65%)] opacity-0 transition-opacity duration-300 group-hover:opacity-100"
      />
      <CountUp
        value={target}
        suffix={suffix}
