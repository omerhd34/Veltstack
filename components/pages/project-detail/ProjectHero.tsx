  ...
  return (
    <>
      ...
      >
        ...
        <div
          aria-hidden
          className="pointer-events-none absolute -right-24 top-10 size-120 rounded-full bg-emerald-600/8 blur-[120px]"
        />
        <div
          aria-hidden
          className="pointer-events-none absolute -left-24 bottom-0 size-90 rounded-full bg-emerald-800/6 blur-[100px]"
        />
