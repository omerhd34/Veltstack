...
export const PAGE_HERO_IMAGE_FRAME_CLASS =
  "relative h-[180px] w-full overflow-hidden rounded-3xl border border-emerald-700/30 shadow-[0_24px_80px_rgb(0_0_0/0.45)] sm:h-[320px] lg:h-[min(380px,calc(100dvh-26rem))]";
