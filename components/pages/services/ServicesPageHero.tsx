          ...
          <div className="grid min-h-0 flex-1 items-start gap-4 sm:gap-5 lg:grid-cols-[1fr_1fr] lg:items-center lg:gap-12">
            ...
            >
              <div className="min-w-0">
                ...
                <p className="mt-3 hidden max-w-2xl text-sm leading-[1.7] text-emerald-50/65 sm:max-w-3xl md:max-w-4xl xl:mt-3 xl:block xl:max-w-xl xl:text-[0.9375rem] xl:leading-[1.75]">
                  {subtitleSecondary}
                </p>
              </div>
            </SectionScrollReveal>
