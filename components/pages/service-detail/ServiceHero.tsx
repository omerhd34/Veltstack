  ...
  return (
    <>
      ...
      >
        ...
        <SiteContainer className="relative flex min-h-[calc(100dvh-4.5rem)] flex-col pt-4 pb-8 sm:py-10">
          <div className="grid min-h-0 flex-1 items-start gap-8 lg:grid-cols-[1fr_1fr] lg:items-center lg:gap-12">
            <SectionScrollReveal
              direction="left"
              when="mount"
              className="min-w-0"
