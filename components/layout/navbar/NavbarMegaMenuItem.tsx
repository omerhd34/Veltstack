    ...
    <div className="mega-menu-card">
      ...
      >
        <SoftPrefetchLink
          ...
          onClick={onNavigate}
          className={cn(
            "mega-menu-item group relative z-1 flex h-full w-full items-center gap-3 rounded-xl bg-transparent px-3.5 py-3 transition-all duration-150",
        ...
        >
          <span
            className={cn(
              ...
              "transition-all duration-150 group-hover:bg-brand-accent group-hover:text-brand-accent-foreground group-hover:ring-brand-accent/40",
          ...
          <span className="min-w-0 flex-1 font-(family-name:--font-heading) text-sm font-semibold leading-snug tracking-tight text-foreground transition-colors duration-150 group-hover:text-brand-accent group-data-[overlay=true]/header:text-white group-data-[overlay=true]/header:group-hover:text-white">
            <span className="line-clamp-2">{title}</span>
          </span>
          <LuArrowUpRight
            className="size-4 shrink-0 text-brand-accent opacity-0 transition-all duration-150 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 group-hover:opacity-100 group-data-[overlay=true]/header:text-white"
            aria-hidden
          />
        </SoftPrefetchLink>
      </StardustShell>
