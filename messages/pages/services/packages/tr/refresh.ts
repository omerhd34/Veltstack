...
export const refreshPackagesTr = {
  portfolio: {
    ...
    introP2:
      "Tanıtım sitenizin yenileme kapsamını netleştiririz. SEO sıralamanızı koruyarak performans ve dönüşüm odaklı bir yapıya geçiş planlıyoruz.",
    tiers: {
      temel: {
        deliveryDays: "7-14",
        revisions: "2",
  ...
  corporate: {
    ...
    introP2:
      "Kurumsal sitenizin yenileme kapsamını netleştiririz. Mevcut içerik ve entegrasyonlarınızı koruyarak kesintisiz geçiş sağlıyoruz.",
    tiers: {
      temel: {
        deliveryDays: "10-18",
        revisions: "2",
  ...
  ecommerce: {
    ...
    introP2:
      "E-ticaret mağazanızın yenileme kapsamını netleştiririz. Ürün verilerinizi ve organik görünürlüğünüzü koruyarak dönüşüm odaklı bir mağazaya geçiyoruz.",
    tiers: {
      temel: {
        deliveryDays: "14-21",
        revisions: "2",
