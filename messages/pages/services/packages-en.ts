import { appPackagesEn } from "./packages/en/app";
import { auditPackagesEn } from "./packages/en/audit";
import { maintenancePackagesEn } from "./packages/en/maintenance";
import { refreshPackagesEn } from "./packages/en/refresh";
import { seoPackagesEn } from "./packages/en/seo";
...
export const servicesPackagesEn = {
  ...
  statRevision: "Number of revisions",
  ...
  webIntroP2:
    "Portfolio, corporate and ecommerce solutions in Startup, Professional and Premium tiers. On Premium, corporate sites grow with unlimited pages; ecommerce platforms expand without product or category limits. If you are unsure which package to choose, feel free to get in touch.",
  ...
  seoIntroP1:
    "We provide end-to-end SEO and digital marketing support for sustainable search growth—from technical audits and monthly optimization to local visibility and ad campaigns.",
  seoIntroP2:
    "We define scope around your needs. A prioritized action list and progress reporting make it clear what happens when—and you can expand the scope as you grow.",
  ...
  auditIntroP2:
    "We offer a comprehensive technical audit for your website or mobile app. Findings are delivered as a prioritized action plan with actionable improvement steps.",
  maintenanceIntroTitle: "Always-on digital assets",
  maintenanceIntroP1:
    "Updates, backups, security monitoring and emergency response—ongoing support for your website, mobile app and backend infrastructure all in one place.",
  maintenanceIntroP2:
    "Monitoring, backups and technical support are included in the maintenance scope. Scope and SLA are clarified based on your needs.",
  webPackages: webPackagesEn,
  refreshPackages: refreshPackagesEn,
  appPackages: appPackagesEn,
  seoPackages: seoPackagesEn,
  auditPackages: auditPackagesEn,
  maintenancePackages: maintenancePackagesEn,
} as const;
